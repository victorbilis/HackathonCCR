...
class _CarteiraState extends State<Carteira> {
  ...
  void getSaldo() async {
    var balance = await EthereumUtils.getInformationFromContract(
        globals.privKey, 'myBalance', []);
    print(balance);
    FlutterMoneyFormatter fmf =
        FlutterMoneyFormatter(amount: double.parse(balance[0].toString()));
    setState(() {
      saldo = fmf.output.nonSymbol;
      globals.saldo = fmf.output.nonSymbol;
    });
  }
                        ...
                        children: <Widget>[
                          Padding(
                            ...
                            child: Text(
                              ...
                              style: TextStyle(
                                  fontSize: 28, color: Color(0XFF963521)),
                            ),
                          )
                        ],
                      ),
